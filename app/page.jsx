    ...
    if (content?.type === 'tasacion') {
      ...
      return (
        <div className="tasacion-card" ref={tasRef}>
          ...
          <button
            onClick={() => {
              // El informe se abre en su propia pestaña: los datos viajan por localStorage
              try { localStorage.setItem('iaprop_informe', JSON.stringify(content)) } catch (e) {}
