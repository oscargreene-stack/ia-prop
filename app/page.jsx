  ...
  return (
    <>
      <div className="landing">
        ...
        const errData = await tasRes.json().catch(() => ({}))
        setMessages(m => m.filter(x => !(x.role==='agent' && x.content?.type==='loading')))
        await addAgent(`Para tasar necesito los metros cuadrados reales del SII. No es posible hacer una tasación con datos estimados.\n\n¿Cuántos **m² construidos** tiene la propiedad? (encuéntralos en el certificado de avalúo del SII)`, 800)
        setInputMode('text'); setStage('ingresar_m2_construido'); return
      }
